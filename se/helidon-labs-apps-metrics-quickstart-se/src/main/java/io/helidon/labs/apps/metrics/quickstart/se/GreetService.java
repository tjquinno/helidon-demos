package io.helidon.labs.apps.metrics.quickstart.se;
...
class GreetService implements HttpService {
    ...
    GreetService(Config appConfig) {
        ...
        allGetsTimer = Metrics.globalRegistry().getOrCreate(Timer.builder("allGets")
    ...
    private void getMessageHandler(ServerRequest request,
        ...
        allGetsTimer.record(Duration.ofNanos(System.nanoTime() - start));
    }
